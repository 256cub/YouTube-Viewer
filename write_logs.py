...
class App:
    ...
    def __init__(self, root):
        ...
        form_frame = ttk.Labelframe(horizontal_pane, text="Video Detail Here")
        ...
        third_frame = ttk.Labelframe(vertical_pane, text="Additional Info Here")
